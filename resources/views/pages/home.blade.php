...
@section('content')
  ...
  <section class="min-h-screen bg-mobile bg-cover bg-center bg-no-repeat relative" aria-label="{{ __('home.title') }}">
    {{-- J’utilise une balise <section> pour structurer ma page.
      ...
      <div class="relative z-10 max-w-6xl mx-auto px-6 py-16 md:py-24 grid md:grid-cols-2 gap-12 items-center">
        <div>
          <p class="font-barlow-condensed uppercase tracking-[0.3em] text-gray-300 text-sm md:text-base mb-6">
            {{ __('home.subtitle') }}
          </p>

          <h1 class="font-bellefair leading-none mb-6 text-5xl sm:text-6xl md:text-7xl lg:text-8xl uppercase">
            {{ __('home.title') }}
          </h1>

          <p class="font-barlow text-gray-300 max-w-xl text-sm md:text-base leading-relaxed">
            {{ __('home.description') }}
          </p>
